...
-(IBAction)removeEmployee:(id)sender
{
    ...
    NSAlert *alert = [NSAlert alertWithMessageText:@"Do you really want to remove these people?" defaultButton:@"Remove" alternateButton:@"Cancel" otherButton:@"Keep, No Raise" informativeTextWithFormat:@"%ld people will be removed", (unsigned long)[selectedPeople count]];
...
{
    NSLog(@"Got note: %@",note);
    [tableView setBackgroundColor:[[note userInfo] objectForKey:@"color"]];
}
